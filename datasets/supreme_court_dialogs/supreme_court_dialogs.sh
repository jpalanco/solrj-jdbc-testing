...
curl -H 'Content-type:application/json' --data-binary '{
  "add-field":{"name":"case_id","type":"string","indexed":true,"stored":true},
  "add-field":{"name":"utterance_id","type":"string","indexed":true,"stored":true},
  "add-field":{"name":"after_previous","type":"string","indexed":true,"stored":true},
  "add-field":{"name":"speaker","type":"string","indexed":true,"stored":true},
  "add-field":{"name":"is_justice","type":"string","indexed":true,"stored":true},
  "add-field":{"name":"justice_vote","type":"string","indexed":true,"stored":true},
  "add-field":{"name":"presentation_side","type":"string","indexed":true,"stored":true},
...
curl -H 'Content-type:application/json' --data-binary '{
  "add-field":{"name":"case_id","type":"string","indexed":true,"stored":true},
  "add-field":{"name":"winning_side","type":"string","indexed":true,"stored":true}
}' "http://$SOLR/solr/$COLLECTION/schema"
...
curl -H 'Content-type:application/json' --data-binary '{
  "add-field":{"name":"case_id","type":"string","indexed":true,"stored":true},
  "add-field":{"name":"justice_name_side_voted_for_1","type":"string","indexed":true,"stored":true},
  "add-field":{"name":"justice_name_side_voted_for_2","type":"string","indexed":true,"stored":true},
  "add-field":{"name":"justice_name_side_voted_for_3","type":"string","indexed":true,"stored":true},
  "add-field":{"name":"justice_name_side_voted_for_4","type":"string","indexed":true,"stored":true},
  "add-field":{"name":"justice_name_side_voted_for_5","type":"string","indexed":true,"stored":true},
  "add-field":{"name":"justice_name_side_voted_for_6","type":"string","indexed":true,"stored":true},
  "add-field":{"name":"justice_name_side_voted_for_7","type":"string","indexed":true,"stored":true},
  "add-field":{"name":"justice_name_side_voted_for_8","type":"string","indexed":true,"stored":true},
  "add-field":{"name":"justice_name_side_voted_for_9","type":"string","indexed":true,"stored":true}
}' "http://$SOLR/solr/$COLLECTION/schema"
